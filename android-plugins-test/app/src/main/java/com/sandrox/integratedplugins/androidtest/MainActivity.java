...
public final class MainActivity extends ComponentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new ThumbnailAdapter(items, this::openViewer));
    ...
    private void openViewer(int position, ImageView sourceView) {
        if (position < 0 || position >= items.size() || overlayView != null) {
            return;
        }
